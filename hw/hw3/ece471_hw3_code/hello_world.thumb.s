...
print_string:
	...
	push    {r0,r2,r6,r7,lr}	@ Save r0,r2,r6,r7,lr on stack
...
find_length:
	...
	pop	{r0,r2,r6,r7,pc}       @ pop r0,r2,r3,pc from stack
...
print_number:
	push	{r0,r10,LR}	@ Save r10 and return address on stack
...
write_out:
        ...
        pop	{r0,r10,LR}	@ restore saved values from stack
